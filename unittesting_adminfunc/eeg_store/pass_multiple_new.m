...
[rALLEEG rEEG rCURRENTSET] = eeg_store(inALLEEG, [EEG2 EEG3 EEG4]);


if ~near( [rALLEEG([1 2 3 4]).data], [EEG1.data EEG2.data EEG3.data  EEG4.data])
