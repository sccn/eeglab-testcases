...
% function passed = i_pass_help_cell()
% geometry = {[1 1], 1};
...
% % eeglab 5.03: helpcom must be a string but could be used as cellarray
% % one button 'help gui' and one button 'more help'
% helpcom = {'disp(''help clicked'');', 'disp(''more clicked'');'};
% 
% outparam = inputgui('geometry', geometry, 'uilist', uilist, 'helpcom', helpcom);
% 
