...
function pass_column_vector()
		...
		data = [1; 3];
		ceigvec = [[0 1]; ...	% expected eigenvectors
				   [1 0]];
		ceigval = [0 0];		% expected eigenvalues
		ccompressed = [0; 0];	% expected compressed data (by multiplicating with data without column means)
		cmean = [1 3];			% expected data mean
