...
function pass_multiple_events_colorout()
        ...
        rej = [ [ 4.0082 5.0000 ...        % selected part in data
                ...
                [ 2.5000 3.4000 ...        % selected part in data
                  ...
                  0.0000 0.0000 0.0000 ] ];
        colorin = [ ];
        colorout = [ 1.0000 0.8345 0.9560 ];

        cevents = [ [ 5.0000 1.0000 ...
                      4.0000 5.0000 ... % rounded
                      0.8345 1.0000 0.9560 ] ];
        revents = eegplot2event(rej, 5, colorin, colorout);
