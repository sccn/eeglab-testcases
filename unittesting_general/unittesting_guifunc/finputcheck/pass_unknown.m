...
function passed = pass_unknown()

        varg = { 'key1', 3, ...
                 'the2test', 'foo', ...
                 'p3rcent', 0.4937, ...
                 'forth', {'a', 2, '11b', 'D'}, ...
                 'invisible', 'true' }; % argument unknown
        correct.key1 = 3;
        correct.the2test = 'foo';
        correct.p3rcent = 0.4937;
        correct.forth = {'a', 2, '11b', 'D'};
        correct.invisible = 'true';
        cvargout = {'invisible', 'true'};

        [result, rvargout] = finputcheck(varg, ...
                     { 'the2test', 'string',  [],    ['bar']; ...
                       'key1',     'integer', [1 5], [2]; ...
